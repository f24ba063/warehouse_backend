...
-- PRODUCT_MASTER
-- =========================
INSERT INTO PRODUCT_MASTER (PRODUCT_NAME, MAKER_NAME, UNIT_OF_MEASURE, CATEGORY, SAFETY_STOCK, ORDER_QTY, MIN_ORDER_QTY, IS_LOT_MANAGED, IS_ACTIVE)
VALUES 
('商品A', 'メーカーA', 'PCS', 'カテゴリー1', 10, 2, 2, 1, 1),
('商品B', 'メーカーB', 'KG', 'カテゴリー2', 5, 500, 1000, 0, 1),
('商品C', 'メーカーC', 'M', 'カテゴリー3', 8, 40, 200, 1, 1),
('商品D', 'メーカーD', 'M', 'カテゴリー3', 8, 3, 6, 1, 1),
('商品E', 'メーカーA', 'M', 'カテゴリー3', 8, 3, 3, 0, 1),
('商品F', 'メーカーA', 'M', 'カテゴリー1', 8, 40, 40, 0, 1),
('商品G', 'メーカーA', 'M', 'カテゴリー2', 8, 2000, 6000, 1, 1),
('商品H', 'メーカーB', 'M', 'カテゴリー2', 8, 500, 500, 0, 1),
('商品I', 'メーカーB', 'M', 'カテゴリー3', 8, 50, 100, 1, 1),
('商品J', 'メーカーC', 'M', 'カテゴリー1', 8, 10, 30, 1, 1),
('商品K', 'メーカーC', 'M', 'カテゴリー4', 8, 50, 100, 0, 1),
('商品L', 'メーカーD', 'M', 'カテゴリー6', 8, 10, 50, 1, 1),
('商品M', 'メーカーD', 'M', 'カテゴリー7', 8, 3, 30, 0, 1),
('商品N', 'メーカーA', 'M', 'カテゴリー3', 8, 3, 3, 1, 1);
